...
from functions.f_TFRecord import (convert_to_TFRecord,
...
roll_conn_flat_elements_dict = {datetime.datetime.combine(fd.date_format(key),
...
# shuffle the input (output shuffled in tfrecord accordingly)
input_dict = shuffle_input_dict(input_dict)

# turn train_dict into TFRecord
...
# save test_dict
file_path = os.path.dirname(os.path.realpath(__file__))
save_path = file_path + '/docs/' + 'roll_conn_flat_test.pickle'
with open(save_path, 'wb') as f:
    pickle.dump(test_flat_dict, f)
'''
#
#
#
