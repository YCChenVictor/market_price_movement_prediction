'''
Use keras to construct
'''

import tensorflow as tf
from functions.f_train_model_CNN_RNN import (read_and_decode,
                                             neural_network_CNN_RNN)
import os
...
num_of_data = Post_requisite["num_of_data"]
...
filename = './docs/py_Train_elements.tfrecords'
#
#
#
#
...
#
#
# tensors related to making prediction
y = neural_network_CNN_RNN(x, conns_for_one_element)
#
#
...
input_batch, output_batch = read_and_decode(filename,
                                            batch_size,
                                            num_of_epoches,
...
with tf.Session() as sess:
    ...
    # start the training
    save_path = './model_CNN_RNN/tf_trained_model'
    count = 1
    batch = 1
    epoch = 1
