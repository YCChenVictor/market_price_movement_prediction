...
volatilities_filename = "docs/volatilities.pickle"
roll_conn_filename = "docs/train/roll_conn.pickle"
movement_filename = "docs/movement.pickle"
max_lag = 20
...
movement = Movement(
    f"docs/market_prices/train/{train_predict_ticker}.csv", movement_filename
)
